...
<body>
<div class="container">
    <h1>Olá! <?php print($_GET['userName']) ?></h1>
    <h1>Cadastre o cliente </h1>

    <form action="http://localhost/clientes/lista.php" method="post" class="formulario">
        <div class="mb-3">
        ...
        <div class="listaClientes">
            <form action="http://localhost/clientes/lista.php" method='post'>
